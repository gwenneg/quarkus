...
public class CacheKeyBuilderTest {
     ...
     * CacheKeyBuilder.build((Object) null);
     ...
     * Object compositeKey1 = CacheKeyBuilder.build(keyElement1, keyElement2, keyElement3);
     * Object compositeKey2 = CacheKeyBuilder.build(keyElement1, keyElement2, keyElement3);
     ...
     * Object compositeKey3 = CacheKeyBuilder.build(keyElement2, keyElement1, keyElement3);
     * assertNotEquals(compositeKey2, compositeKey3);
     * 
     * // Two cache keys built from a different number of elements should not be equal.
     * Object compositeKey4 = CacheKeyBuilder.build(keyElement1, keyElement2, keyElement3, keyElement1, keyElement2,
     * keyElement3);
     ...
     * Object compositeKey5 = CacheKeyBuilder.build(new AtomicInteger(456), keyElement2, keyElement3);
     * assertNotEquals(compositeKey2, compositeKey5);
     * Object compositeKey6 = CacheKeyBuilder.build(keyElement1, new Object(), keyElement3);
     * assertNotEquals(compositeKey2, compositeKey6);
     * Object compositeKey7 = CacheKeyBuilder.build(keyElement1, keyElement2, new BigDecimal(10));
