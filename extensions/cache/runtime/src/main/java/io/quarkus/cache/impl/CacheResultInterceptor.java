    ...
    public Object intercept(InvocationContext context) throws Exception {
        ...
        try {
            ...
            if (binding.lockTimeout() <= 0) {
                ...
                /*
                 * If the current key is not already associated with a value in the Caffeine cache, there's no way to know if
                 * the current thread or another one started the missing value computation. The following variable will be used
                 * to determine whether or not a timeout should be triggered during the computation depending on which thread
                 * started it.
                 */
