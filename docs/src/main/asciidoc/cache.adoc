...
See the <<micrometer.adoc,Micrometer metrics guide>> to learn how to use Micrometer in Quarkus.
====
...
Tags can be added to these metrics.
This is also configured from the `application.properties` file:

[source,properties]
----
quarkus.cache.caffeine."foo".metrics.tags=tag1,value1,tag2,value2 <1>
----
<1> The `tags` configuration value must contain an even number of values representing key/value pairs of tags.
...
cache_size{cache="foo",tag1="value1",tag2="value2",} 8.0
# HELP cache_puts_total The number of entries added to the cache
# TYPE cache_puts_total counter
cache_puts_total{cache="foo",tag1="value1",tag2="value2",} 12.0
# HELP cache_gets_total The number of times cache lookup methods have returned a cached value.
# TYPE cache_gets_total counter
cache_gets_total{cache="foo",result="hit",tag1="value1",tag2="value2",} 53.0
cache_gets_total{cache="foo",result="miss",tag1="value1",tag2="value2",} 12.0
# HELP cache_evictions_total cache evictions
# TYPE cache_evictions_total counter
cache_evictions_total{cache="foo",tag1="value1",tag2="value2",} 4.0
...
cache_eviction_weight_total{cache="foo",tag1="value1",tag2="value2",} 540.0
----
